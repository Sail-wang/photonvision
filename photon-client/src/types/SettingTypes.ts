...
export interface PVCameraInfoBase {
  ...
  */
  cameraTypename: "PVUsbCameraInfo" | "PVCSICameraInfo" | "PVFileCameraInfo" | "PVHikvisionCameraInfo";
}
...
export interface PVHikvisionCameraInfo {
  serialNumber: string;
...
export class PVCameraInfo {
  ...
  PVHikvisionCameraInfo: PVHikvisionCameraInfo | undefined;
}
